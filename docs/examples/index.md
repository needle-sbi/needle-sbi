...
The demo documentation is in `examples/fair_universe_demo/docs/` and covers:

- [Overview and physics context](../../examples/fair_universe_demo/docs/overview.md) — what
  NSBI is, what the HiggsML challenge asks for, and how this pipeline answers it.
- [Models](../../examples/fair_universe_demo/docs/models.md) — the conditional normalizing flow
  and combined classifier architectures, their hyperparameters, and training objectives.
- [Data and systematics](../../examples/fair_universe_demo/docs/data_and_systematics.md) — the
  HiggsML dataset, feature engineering, and how detector systematics are modelled.
- [Downstream tasks](../../examples/fair_universe_demo/docs/tasks.md) — each analysis step from
  histogram generation through Neyman construction to the final scored result.
